...
require('lazy').setup({
  -- NOTE: Plugins can be added with a link (or for a github repo: 'owner/repo' link).
  {
    ...
    config = function()
      ...
      vim.cmd [[ autocmd BufReadPost * : GuessIndent silent]]
    end,
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sh', builtin.command_history, { desc = '[S]earch [H]istory: commands' })
    ...
    config = function()
      ...
      require('kanagawa').setup {
        ...
        overrides = function(colors)
          return {
            ['@lsp.typemod.class.defaultLibrary'] = { link = '@lsp.typemod.function.defaultLibrary' },
            ['@lsp.typemod.method.readonly'] = { link = '@lsp.typemod.function.readonly' },
            ['@lsp.typemod.parameter.readonly'] = { fg = colors.theme.syn.parameter, italic = true },
          }
        end,
      }
...
require('custom.lspconfig').configure()
